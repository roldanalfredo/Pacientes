...
async function loadRegistros() {
  ...
  (data || []).forEach(r => {
    ...
    tr.innerHTML = `
      ...
      <td><button class="btn-edit" title="Editar paciente" onclick="editPaciente(${r.paciente_id})">⚙</button> <button class="btn-edit" title="Editar registro" onclick="editRegistro(${r.id})">✎</button> <button class="btn-danger" title="Eliminar registro" onclick="deleteRegistro(${r.id})">✕</button></td>
    `;
    tbody.appendChild(tr);
  });
